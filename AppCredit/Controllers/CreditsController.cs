...
namespace AppCredit.Api.Controllers
{
    ...
    public class CreditsController : ControllerBase
    {
        ...
        public CreditsController(GenericService genericService, IMapper mapper, ILoanService creditService)
        {
        ...
        [HttpGet]
        public IEnumerable<Loan> GetAmortization(decimal capital, decimal bankRate, int quantityAliquot, int modality)
        {
